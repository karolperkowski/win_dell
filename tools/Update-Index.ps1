...
$Annotations = @{
    ...
    'RULES.md'                       = 'Contributor "do / don''t" non-negotiables (summary of CLAUDE.md)'
    ...
    'core/TimeSync.ps1'             = 'Stage 1: timezone, w32time service, NTP peers, poll + reboot-retry fallback'
    'core/PowerSettings.ps1'        = 'Stage 2: power plan, sleep, and display timeout settings'
    'core/Debloat.ps1'              = 'Stage 3: remove bloatware apps from bloatware.json lists'
    'core/WinTweaks.ps1'            = 'Stage 4: registry tweaks, dark theme, DPI, Chrome, WinUtil preset'
    'core/AppInstall.ps1'           = 'Stages 5-7: Dell SupportAssist, Dell Power Manager, RustDesk'
    'core/Tailscale.ps1'            = 'Stage 8: Tailscale install + QR-based registration'
    'core/RemoteAccess.ps1'         = 'Stage 9: RDP + WinRM (TrustedHosts=100.*) + OpenSSH'
    'core/WindowsUpdate.ps1'        = 'Stage 10: Windows Update (last -- multiple reboots expected)'
    'core/Cleanup.ps1'              = 'Stage 11: remove tasks, disable auto-logon, final reboot'
