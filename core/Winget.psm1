...
$Script:WINGET_EXIT_MEANINGS = @{
    0           = 'Success'
    -1978335231 = 'Internal error (0x8A150001)'
    -1978335230 = 'Invalid command-line arguments (0x8A150002) - winget rejected the install args. Common cause: malformed manifest, unsupported flag combination, or older winget that does not understand a newer flag.'
    -1978335229 = 'Executing command failed (0x8A150003)'
    -1978335228 = 'Opening manifest failed (0x8A150004)'
    -1978335227 = 'Showing help requested (0x8A150005)'
    -1978335226 = 'Command requires admin (0x8A150006)'
    -1978335225 = 'Source name already exists (0x8A150007)'
    -1978335224 = 'Invalid source type (0x8A150008)'
    -1978335223 = 'Package agreement not accepted (0x8A150009)'
    -1978335222 = 'Source not remote (0x8A15000A)'
    -1978335221 = 'Unsupported source argument (0x8A15000B)'
    -1978335220 = 'Source name already added (0x8A15000C)'
    -1978335219 = 'Source open failed (0x8A15000D)'
    -1978335218 = 'Source agreements not accepted (0x8A15000E)'
    -1978335217 = 'Promp t input not valid (0x8A15000F)'
    -1978335216 = 'No applicable update found (0x8A150010)'
    -1978335215 = 'No applicable installer for current system (0x8A150011)'
    -1978335214 = 'Installer hash does not match (0x8A150012)'
    -1978335213 = 'Source name does not exist (0x8A150013)'
    -1978335212 = 'Multiple packages match the input criteria (0x8A150014)'
    -1978335211 = 'Cannot agree to package agreements (0x8A150015)'
    -1978335210 = 'Source agreements failed (0x8A150016)'
    -1978335209 = 'Cannot agree to source agreements (0x8A150017)'
    -1978335208 = 'Source agreement not accepted (0x8A150018)'
    -1978335200 = 'No package found matching input criteria (0x8A150020)'
    -1978335199 = 'Missing winget package source (0x8A150021)'
    -1978335189 = 'Already installed (0x8A15002B)'
    -1978335186 = 'Install in progress (0x8A15002E)'
