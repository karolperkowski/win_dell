...
|---|---|
| Files | 43 |
| PowerShell | 27 files, 8,897 lines |
| Total size | 416 KB |
...
| `INDEX.md` | 69 | 4.4 KB | Auto-generated file inventory (this file) |
...
| | | | |
| `config/settings.json` | 158 | 4.9 KB | All deployment configuration -- edit this, not the scripts |
...
| `core/Config.psm1` | 117 | 4.7 KB | Shared constants ($WD.*) -- single source of truth for paths and stage order |
...
| `core/Orchestrator.ps1` | 583 | 23.9 KB | Master controller -- runs stages in order, handles reboots |
...
| `tools/Troubleshoot.ps1` | 611 | 27.0 KB | Status / Diagnose / Repair entry point - auto-fired by Orchestrator + Watchdog |
