...
|---|---|
| Files | 43 |
| PowerShell | 27 files, 8,185 lines |
| Total size | 383 KB |
...
| `CLAUDE.md` | 220 | 15.3 KB | AI-assisted development context and conventions |
...
| `README.md` | 273 | 12.9 KB | Project overview and usage documentation |
| `reinstall.ps1` | 59 | 2.6 KB | WinDeploy reinstall — clean uninstall + fresh install in one step. |
| `RULES.md` | 52 | 5.2 KB | Contributor "do / don't" non-negotiables (summary of CLAUDE.md) |
...
| `tools/Update-Index.ps1` | 234 | 11.1 KB | Generates INDEX.md file inventory (this script) |
